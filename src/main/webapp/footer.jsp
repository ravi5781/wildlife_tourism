        ...
        <a href="guide.jsp" class="mb-2">Guide Service</a>
            ...
            <div class="col-md-3">
                ...
                <div class="contact-info">
                    <p><i class="fas fa-phone me-2"></i>9019225781</p>
                    <p><i class="fas fa-envelope me-2"></i>rsgroupof@company.com</p>
                    <p><i class="fas fa-map-marker-alt me-2"></i>GEC boys Hostel, GEC Hassan.</p>
                </div>
            </div>
